...
:ref:`AAAAAA project tree <concepts-project-structure>` do not need to be
tracked by :ref:`tools-Git`. It contains some
...
it is :ref:`configured <concepts-configs>` in :ref:`configs-settings-json`
using the official :vs-code-ext:`configuration options <vscodevim.vim>`
...
:ref:`sphinx-quickstart <dist-doc>`, you will end up with a ``conf.py``
:wiki-pg:`file <Computer_file>` in your
...
of :ref:`global module variables <python:tut-modules>`.
...
These were created during :ref:`sphinx-quickstart <dist-doc>`, and have not
been modified. See :ref:`conf.py <concepts-configs-tree>` for the original
:ref:`comments <python:comments>` that were automatically generated
...
:ref:`requirements.txt <concepts-configs-tree>` for this to work
