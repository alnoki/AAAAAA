...
## BibTex
1. Create a "sphinx" procedure
   1. If author is empty, may get an error saying editor is empty
         1. http://bib-it.sourceforge.net/help/fieldsAndEntryTypes.php#editor
   1. Appears the link requires author name, and uses 'last name' to make link
      1. assorted authors + 2010 = aut10
   1. Should be reciprically cross-linked with tools-bibtex
1. Follow procedure to add to a conda package
   1. Is it only from conda forge?
      1. Yep
1. You can't change the name generated by the role
1. Explain at the top of the books page to click link to go to bibliography
1. Use a header so a contents directive can organize them

## Sphinx extensions write up
1. xref
1. intersphinx
1. The Sphinx extensions table should link to the respective extensions
